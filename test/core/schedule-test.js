...
describe('Schedule', function () {
  ...
  describe('nextRange', function () {
    ...
    it('should return undefined as end if there is no end date', function () {
      ...
      schedule(s)
        .nextRange(3, d)
        .should.eql([[new Date('2013-03-21T00:00:05Z'), undefined]]);
    });
  ...
  describe('prevRange', function () {
    ...
    it('should return undefined as end if there is no end date', function () {
      ...
      schedule(s)
        .prevRange(3, d)
        .should.eql([[undefined, new Date('2013-03-21T00:00:05Z')]]);
    });
