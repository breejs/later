...
describe('Parse Cron', function () {
  ...
  describe('minutes', function () {
    ...
    it('should parse issue #100 correctly', function () {
      ...
      p.schedules[0].should.eql({
        s: [0],
        m: [4, 9, 14, 19, 24, 29, 34, 39, 44, 49, 54, 59]
      });
    });
  });
