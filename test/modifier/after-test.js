...
describe('Modifier After', function () {
  describe('name', function () {
    ...
    it('should append "after" before a time constraint', function () {
      later.date.UTC();
      const after = later.modifier.after(later.t, [15]);
  ...
  describe('range', function () {
    ...
    it('should be the number of seconds covered by the time range', function () {
      later.date.UTC();
      const after = later.modifier.after(later.t, [60000]);
      after.range.should.equal(26399);
    });
  });

  describe('val', function () {
    const d = new Date('2013-03-21T03:10:00Z');

    it('should return the correct minutes value when less than constraint', function () {
      later.date.UTC();
      const after = later.modifier.after(later.m, [5]);
    ...
    it('should be the number of seconds covered by the time range when less than constraint', function () {
      later.date.UTC();
      const after = later.modifier.after(later.t, [10000]);
    ...
    it('should be the number of seconds covered by the time range when greater than constraint', function () {
      later.date.UTC();
      const after = later.modifier.after(later.t, [20000]);
      after.val(d).should.equal(11400);
    });
  });
  ...
  describe('isValid', function () {
    ...
    it('should return true if the current minute val is equal to the constraint', function () {
      later.date.UTC();
      const after = later.modifier.after(later.m, [10]);
    ...
    it('should return true if the current time val is equal to the constraint', function () {
      later.date.UTC();
      const after = later.modifier.after(later.t, [11400]);
  ...
  describe('next', function () {
    ...
    it('should return start of range if val equals time constraint', function () {
      later.date.UTC();
      const after = later.modifier.after(later.t, [11520]);
  ...
  describe('compiled minute schedule', function () {
    const c = later.compile({ m_a: [30] });

    it('should tick to next consecutive minutes', function () {
      later.date.UTC();
      const d = new Date('2013-03-21T03:31:00Z');
      const expected = new Date('2013-03-21T03:32:00Z');
      const actual = c.tick('next', d);
    ...
    it('should tick to prev consecutive minutes', function () {
      later.date.UTC();
      const d = new Date('2013-03-21T03:26:00Z');
      const expected = new Date('2013-03-21T03:25:59Z');
      const actual = c.tick('prev', d);
    ...
    it('should go the next valid value when invalid', function () {
      later.date.UTC();
      const d = new Date('2013-03-21T03:25:00Z');
      const expected = new Date('2013-03-21T03:30:00Z');
      const actual = c.start('next', d);
    ...
    it('should go the prev valid value when invalid', function () {
      later.date.UTC();
      const d = new Date('2013-03-21T03:25:00Z');
      const expected = new Date('2013-03-21T02:59:59Z');
      const actual = c.start('prev', d);
    ...
    it('should go the end of constraint value when valid for prev', function () {
      later.date.UTC();
      const d = new Date('2013-03-21T03:45:10Z');
      const expected = new Date('2013-03-21T03:45:59Z');
      const actual = c.start('prev', d);
    ...
    it('should go the start of constraint value when valid for next', function () {
      later.date.UTC();
      const d = new Date('2013-03-21T03:45:10Z');
      const expected = new Date('2013-03-21T03:45:00Z');
      const actual = c.start('next', d);
    ...
    it('should go the end of the constraint', function () {
      later.date.UTC();
      const d = new Date('2013-03-21T03:45:10Z');
      const expected = new Date('2013-03-21T04:00:00Z');
      const actual = c.end('next', d);
  ...
  describe('compiled time schedule', function () {
    const c = later.compile({ t_a: [11400] });

    it('should tick to next consecutive minutes', function () {
      later.date.UTC();
      const d = new Date('2013-03-21T03:31:00Z');
      const expected = new Date('2013-03-21T03:31:01Z');
      const actual = c.tick('next', d);
    ...
    it('should go the next valid value when invalid', function () {
      later.date.UTC();
      const d = new Date('2013-03-21T03:05:00Z');
      const expected = new Date('2013-03-21T03:10:00Z');
      const actual = c.start('next', d);
    ...
    it('should go the prev valid value when invalid', function () {
      later.date.UTC();
      const d = new Date('2013-03-21T03:05:00Z');
      const expected = new Date('2013-03-20T23:59:59Z');
      const actual = c.start('prev', d);
    ...
    it('should go the start of constraint value when valid for prev', function () {
      later.date.UTC();
      const d = new Date('2013-03-21T03:10:10Z');
      const expected = new Date('2013-03-21T03:10:10Z');
      const actual = c.start('prev', d);
    ...
    it('should go the end of the constraint', function () {
      later.date.UTC();
      const d = new Date('2013-03-21T03:45:10Z');
      const expected = new Date('2013-03-22T00:00:00Z');
      const actual = c.end('next', d);
